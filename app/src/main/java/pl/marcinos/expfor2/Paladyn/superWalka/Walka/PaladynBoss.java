...
public class PaladynBoss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paladyn_boss);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PaladynBoss.this,PaladynMenuActivity.class);
                startActivity(intent);
                PaladynBoss.this.finish();
            }
        });
        if(paladyn.sett==1)
        {
        ...
        progresHpP.setMax(bosshp.hp);
        progresHpB.setProgress(paladyn.hpbohater);
        progresHpP.setProgress(boss.hp);
        View v =this.findViewById(android.R.id.content).getRootView();
        AtakPotwora.AtakPotwora(imageB,imageBatakuj,imageP,paladyn,boss,bosshp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill,buttonPotek);



        textHpB.setText("Hp bohatera: "+paladyn.hpbohater);
        textHpP.setText("Hp Bossa: "+boss.hp);
        buttonWalcz=(ImageButton)findViewById(R.id.buttonWalcz);
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Walka.walczzPotworem(imageAtackTimer,imageBcrit,anim,imageBatakuj,imageB,imageP,paladyn,paladynhp,boss,bosshp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskilla(imageTimer,imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,paladyn,paladynhp,boss,bosshp,textHpB,textHpP,v,buttonSkill);
...
//                   textHpB.setText(archer.hpbohater);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setTitle("Boss Pokonany !!!");
        alertDialogBuilder.setMessage("Zdobyłeś: "+ Drop.drophajsu+"$, "+Drop.dropexp+" exp\n Udało Ci się zdobyć magiczny monument \n Oraz Magiczny kamień");

        alertDialogBuilder.setPositiveButton(("Wracam!"), new DialogInterface.OnClickListener() {
            @Override
