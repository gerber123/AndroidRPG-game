...
public class PaladynStroz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paladyn_stroz);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PaladynStroz.this,PaladynMenuActivity.class);
                startActivity(intent);
                PaladynStroz.this.finish();
            }
        });
        if(paladyn.sett==1)
        {
        ...
        AtakPotwora.AtakPotwora(imageB,imageBatakuj,imageP,paladyn,stroz,strozhp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill,buttonPotek);
        ...
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walczzPotworem(imageAtackTimer,imageBcrit,anim,imageBatakuj,imageB,imageP,paladyn,paladynhp,stroz,strozhp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskilla(imageTimer,imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,paladyn,paladynhp,stroz,strozhp,textHpB,textHpP,v,buttonSkill);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setPositiveButton(("Walcze dalej!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(PaladynStroz.this,PaladynMoskit.class);
                startActivity(intent);
                PaladynStroz.this.finish();
