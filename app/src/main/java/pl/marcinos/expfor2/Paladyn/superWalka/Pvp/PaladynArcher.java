...
public class PaladynArcher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paladyn_archer);
...
//                    imagePatakuj.setVisibility(View.VISIBLE);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PaladynArcher.this,PaladynMenuActivity.class);
                startActivity(intent);
                PaladynArcher.this.finish();
            }
        });
        if(paladyn.sett==1)
        {
