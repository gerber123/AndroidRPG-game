...
public class MiniGraPaladyn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mini_gra_paladyn);
    ...
    private void hitCheck(Bohaterowie x)
    {
        ...
        if(0<=blackCenterX&&blackCenterX<=boxSize&&boxY<=blackCenterY&&blackCenterY<=boxY+boxSize)
        {
            ...
            if(ExpLvl.LvlUpMiniGra(paladyn,paladynhp)==true) {
            ...
            alertDialogBuilder.setPositiveButton(("Wróć do Menu"), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),PaladynMenuActivity.class);

                    startActivity(intent);
                    MiniGraPaladyn.this.finish();
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(MiniGraPaladyn.this,PaladynMenuActivity.class);
        startActivity(intent);
        MiniGraPaladyn.this.finish();
    }
}
