...
import pl.marcinos.expfor2.Paladyn.superWalka.Walka.PaladynGuard;
import pl.marcinos.expfor2.Paladyn.superWalka.Walka.PaladynHellgate;
import pl.marcinos.expfor2.Paladyn.superWalka.Walka.PaladynRycerz;
...
public class WyborTrzyActivity extends AppCompatActivity {
ListView list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wybor_trzy);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                if(position==0) {
                    Intent intent = new Intent(WyborTrzyActivity.this, PaladynGuard.class);
                    WyborTrzyActivity.this.finish();
                    startActivity(intent);
                }
                else if(position==1) {
                    Intent intent = new Intent(WyborTrzyActivity.this, PaladynHellgate.class);
                    WyborTrzyActivity.this.finish();
                    startActivity(intent);
                }
                else if(position==2) {
                    Intent intent = new Intent(WyborTrzyActivity.this, PaladynRycerz.class);
                    WyborTrzyActivity.this.finish();
                    startActivity(intent);
                }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(WyborTrzyActivity.this,PaladynMenuActivity.class);
        startActivity(intent);
        WyborTrzyActivity.this.finish();
    }
}
