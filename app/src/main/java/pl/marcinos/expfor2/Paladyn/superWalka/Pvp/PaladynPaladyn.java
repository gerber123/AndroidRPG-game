...
public class PaladynPaladyn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paladyn_paladyn);
...
//                    imagePatakuj.setVisibility(View.VISIBLE);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PaladynPaladyn.this,PaladynMenuActivity.class);
                startActivity(intent);
                PaladynPaladyn.this.finish();
            }
        });
        if(paladyn.sett==1)
        {
