...
public class ArcherPaladyn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_paladyn);
...
//                    imagePatakuj.setVisibility(View.VISIBLE);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ArcherPaladyn.this,ArcherMenuActivity.class);
                startActivity(intent);
                ArcherPaladyn.this.finish();
            }
        });
        if(archer.sett==1)
        {
