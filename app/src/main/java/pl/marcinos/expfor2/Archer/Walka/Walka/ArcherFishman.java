...
public class ArcherFishman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_fishman);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ArcherFishman.this,ArcherMenuActivity.class);
                startActivity(intent);
                ArcherFishman.this.finish();
            }
        });
        ...
        AtakPotwora.AtakPotwora(imageB,imageBatakuj,imageP,archer,fishman,fishmanhp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill,buttonPotek);
        ...
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walczzPotworem(imageAtackTimer,imageBcrit,anim,imageBatakuj,imageB,imageP,archer,archerhp,fishman,fishmanhp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskilla(imageTimer,imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,archer,archerhp,fishman,fishmanhp,textHpB,textHpP,v,buttonSkill);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setPositiveButton(("Walcze dalej!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ArcherFishman.this,ArcherSoldier.class);
                startActivity(intent);
                ArcherFishman.this.finish();
