...
public class ArcherRycerz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_rycerz);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ArcherRycerz.this,ArcherMenuActivity.class);
                startActivity(intent);
                ArcherRycerz.this.finish();
            }
        });
        ...
        AtakPotwora.AtakPotwora(imageB,imageBatakuj,imageP,archer,rycerz,rycerzhp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill,buttonPotek);
        ...
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walczzPotworem(imageAtackTimer,imageBcrit,anim,imageBatakuj,imageB,imageP,archer,archerhp,rycerz,rycerzhp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskilla(imageTimer,imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,archer,archerhp,rycerz,rycerzhp,textHpB,textHpP,v,buttonSkill);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setPositiveButton(("Walcze dalej!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ArcherRycerz.this,ArcherGuard.class);
                startActivity(intent);
                ArcherRycerz.this.finish();
