...
public class ArcherArcher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_archer);
...
//                    imagePatakuj.setVisibility(View.VISIBLE);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ArcherArcher.this,ArcherMenuActivity.class);
                startActivity(intent);
                ArcherArcher.this.finish();
            }
        });
        if(archer.sett==1)
        {
