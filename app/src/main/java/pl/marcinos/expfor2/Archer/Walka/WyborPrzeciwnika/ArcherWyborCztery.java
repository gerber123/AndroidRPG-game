...
public class ArcherWyborCztery extends AppCompatActivity {
    ListView list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_archer_wybor_cztery);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                if(position==0) {
                    Intent intent = new Intent(ArcherWyborCztery.this, ArcherSoldier.class);
                    ArcherWyborCztery.this.finish();
                    startActivity(intent);
                }
                else if(position==1) {
                    Intent intent = new Intent(ArcherWyborCztery.this, ArcherFishman.class);
                    ArcherWyborCztery.this.finish();
                    startActivity(intent);
                }
                else if(position==2) {
                    Intent intent = new Intent(ArcherWyborCztery.this, ArcherTurtle.class);
                    ArcherWyborCztery.this.finish();
                    startActivity(intent);
                }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(ArcherWyborCztery.this,ArcherMenuActivity.class);
        startActivity(intent);
        ArcherWyborCztery.this.finish();
    }
}
