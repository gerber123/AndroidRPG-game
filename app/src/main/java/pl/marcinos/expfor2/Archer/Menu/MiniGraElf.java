...
public class MiniGraElf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mini_gra_elf);
    ...
    private void hitCheck(Bohaterowie x)
    {
        ...
        if(0<=blackCenterX&&blackCenterX<=boxSize&&boxY<=blackCenterY&&blackCenterY<=boxY+boxSize)
        {
            ...
            if(ExpLvl.LvlUpMiniGra(archer,archerhp)==true) {
            ...
            alertDialogBuilder.setPositiveButton(("Wróć do Menu"), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),ArcherMenuActivity.class);

                    startActivity(intent);
                    MiniGraElf.this.finish();
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(MiniGraElf.this,ArcherMenuActivity.class);
        startActivity(intent);
        MiniGraElf.this.finish();
    }
}
