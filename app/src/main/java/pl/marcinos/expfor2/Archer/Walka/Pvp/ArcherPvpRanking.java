...
public class ArcherPvpRanking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_pvp_ranking);
...
//               AdapterListyFinal myAdapterr = new AdapterListyFinal(ListaDorosleFinal.this,DorosleListFinal);
                    AdapterFinal myAdapterr = new AdapterFinal(ArcherPvpRanking.this,UzytkownicyList);
...
public void ustawPrzeciwnika(final User user)
{
    ...
    {
        Intent intent = new Intent(ArcherPvpRanking.this,ArcherMenuActivity.class);
        startActivity(intent);
        ArcherPvpRanking.this.finish();
    ...
    public void czyChceszWalczycMag(final User user,View v)
    {
        ...
        alertDialogBuilder.setPositiveButton(("Zaczynajmy!"), new DialogInterface.OnClickListener() {
            ...
            if(user.getNazwa().equalsIgnoreCase("mag"))
            {
                ...
                Intent intent = new Intent(ArcherPvpRanking.this, ArcherMag.class);
                startActivity(intent);
                ArcherPvpRanking.this.finish();
            }
                ...
                {
                    ustawPrzeciwnika(user);
                    Intent intent = new Intent(ArcherPvpRanking.this,ArcherPaladyn.class);
                    startActivity(intent);
                    ArcherPvpRanking.this.finish();
                ...
                {
                    ustawPrzeciwnika(user);
                    Intent intent = new Intent(ArcherPvpRanking.this,ArcherArcher.class);
                    startActivity(intent);
                    ArcherPvpRanking.this.finish();
