...
/**
 * Created by marci on 15.03.2018.
 */

public class MyAdapter510 extends BaseAdapter {
    private Context context;
    private List<Potwory> potworyList;
    private LayoutInflater layoutInflater;
    int[] Images = {R.drawable.moskit, R.drawable.mnich, R.drawable.orc, R.drawable.stroz};

    public MyAdapter510(Context context, List<Potwory> potworyList) {
