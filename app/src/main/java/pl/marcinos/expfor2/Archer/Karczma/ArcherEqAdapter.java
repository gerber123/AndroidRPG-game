...
public class ArcherEqAdapter extends BaseAdapter {
    ...
    public ArcherEqAdapter(Context context, List<Itemy> EqList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
         ...
         if(EqList.get(position).getNazwaItema().equalsIgnoreCase("Gold"))
        {
            ...
            viewHolder.Ilosc.setText("Ilość: "+archer.getHajs());
        ...
        {
//            viewHolder.Nick.setText(EqList.get(position).getNazwaWlasna());
            viewHolder.Ilosc.setText("Ilość: "+archer.getIloscKamieni());
        ...
        {
//            viewHolder.Nick.setText(EqList.get(position).getNazwaWlasna());
            viewHolder.Ilosc.setText("Ilość: "+archer.getIloscKamieniPewnych());
        ...
        {
//            viewHolder.Nick.setText(EqList.get(position).getNazwaWlasna());
            viewHolder.Ilosc.setText("Ilość: "+archer.getIloscMonumentow());
            viewHolder.Wartosc.setText("Wartość: Bezcenny");
            viewHolder.opis.setText("Opis: "+EqList.get(position).getOpis());
        }
        ...
        {
//            viewHolder.Nick.setText(EqList.get(position).getNazwaWlasna());
            viewHolder.Ilosc.setText("Ilość: "+archer.getIloscKluczy());
            viewHolder.Wartosc.setText("Wartość: Bezcenny");
            viewHolder.opis.setText("Opis: "+EqList.get(position).getOpis());
        }
         ...
         else if(EqList.get(position).getNazwaItema().equalsIgnoreCase("Pierścień Volda"))
         {
             viewHolder.Nick.setText(EqList.get(position).getNazwaItema());
             viewHolder.Ilosc.setText("Jedna sztuka ");
             viewHolder.Wartosc.setText("Jakoś: Unikalna");
