...
public class ArcherWilkor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_archer_wilkor);
        ...
        imageBcrit = (ImageView)findViewById(R.id.imageViewCrit);
            ...
            buttonBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ArcherWilkor.this,ArcherMenuActivity.class);
                    startActivity(intent);
                    ArcherWilkor.this.finish();
                }
            });
        if(archer.sett==1)
        {
        ...
        Set.zmianaSetuWalkaIntSetD(archer,imageBb,imageBa,imageBs,imageBD);
            ...
            AtakPotwora.AtakPotwora(imageB,imageBatakuj,imageP,archer,wilkor,wilkorhp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill,buttonPotek);
            ...
            buttonWalcz.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Walka.walczzPotworem(imageAtackTimer,imageBcrit,anim,imageBatakuj,imageB,imageP,archer,archerhp,wilkor,wilkorhp,textHpB,textHpP,v,buttonWalcz);
            ...
            buttonSkill.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Walka.walnijzeskilla(imageTimer,imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,archer,archerhp,wilkor,wilkorhp,textHpB,textHpP,v,buttonSkill);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setPositiveButton(("Walcze dalej!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(ArcherWilkor.this,ArcherSzkielet.class);
                startActivity(intent);
                ArcherWilkor.this.finish();
