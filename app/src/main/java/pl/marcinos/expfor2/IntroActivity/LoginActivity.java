                    ...
                    if(!user.isEmpty())
                    {
                        ...
                        if(login.getPassword().equals(pwd)) {
                            ...
                            if(login.bohater.equalsIgnoreCase("mag")) {
                                ...
                                mag.setProfesja(login.getProfesja());
                                mag.setIloscKamieni(login.getIloscKamieni());
                                mag.setIloscKamieniPewnych(login.getIloscKamieniPewnych());
                                mag.setIloscKluczy(login.getIloscKluczy());
                                mag.setIloscMonumentow(login.getIloscMonumentow());
                                mag.setIloscKamieni(login.getIloscKamieni());
                                ...
                                mag.setPierscienVolda(login.getPierscienVolda());
                                mag.setNaszyjnikTorosa(login.getNaszyjnikTorosa());
                                mag.setKolczykiLajamira(login.getKolczykiLajamira());
                                mag.setMaxMana(login.getMaxMana());
                                mag.setMana(login.getMana());
                                ...
                                archer.setIloscKamieni(login.getIloscKamieni());
                                archer.setIloscKamieniPewnych(login.getIloscKamieniPewnych());
                                archer.setIloscKluczy(login.getIloscKluczy());
                                archer.setIloscMonumentow(login.getIloscMonumentow());
//                                archer.setOnline(1);
                                archer.setObrona(login.getObrona());
                                archer.setPierscienVolda(login.getPierscienVolda());
                                archer.setNaszyjnikTorosa(login.getNaszyjnikTorosa());
                                archer.setKolczykiLajamira(login.getKolczykiLajamira());
                                archer.setSet(login.set);
                                archer.setKlucz(login.klucz);
                                archer.setSzansaCrit(login.szansaCrit);
                                archer.setProfesja(login.getProfesja());
                                ...
                                archer.setMana(login.mana);
                                archer.setMaxMana(login.maxMana);
...
//                            maghp.setAtkbohater(login.atkbohater);
                                ...
                                paladyn.setIloscKamieni(login.getIloscKamieni());
                                paladyn.setIloscKamieniPewnych(login.getIloscKamieniPewnych());
                                paladyn.setIloscKluczy(login.getIloscKluczy());
                                paladyn.setIloscMonumentow(login.getIloscMonumentow());
                                paladyn.setSzansaCrit(login.szansaCrit);
                                paladyn.setProfesja(login.getProfesja());
                                ...
                                paladyn.setPierscienVolda(login.getPierscienVolda());
                                paladyn.setNaszyjnikTorosa(login.getNaszyjnikTorosa());
                                paladyn.setKolczykiLajamira(login.getKolczykiLajamira());
