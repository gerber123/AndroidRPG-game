...
public class MagPvpRanking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mag_pvp_ranking);
...
//               AdapterListyFinal myAdapterr = new AdapterListyFinal(ListaDorosleFinal.this,DorosleListFinal);
                    AdapterFinal myAdapterr = new AdapterFinal(MagPvpRanking.this,UzytkownicyList);
...
//
    ...
    {
        Intent intent = new Intent(MagPvpRanking.this,MagMenuActivity.class);
        startActivity(intent);
        MagPvpRanking.this.finish();
        ...
        alertDialogBuilder.setPositiveButton(("Zaczynajmy!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(user.getNazwa().equalsIgnoreCase("mag"))
                {
                    ...
                    Intent intent = new Intent(MagPvpRanking.this, MagMag.class);
//                intent.putExtra("User", user.getUserName());
                ...
                {
                    ustawPrzeciwnika(user);
                    Intent intent = new Intent(MagPvpRanking.this,MagPaladyn.class);
//                    intent.putExtra("User",user.getUserName());
                    startActivity(intent);
                    MagPvpRanking.this.finish();
                ...
                {
                    ustawPrzeciwnika(user);
                    Intent intent = new Intent(MagPvpRanking.this,MagArcher.class);
//                    intent.putExtra("User",user.getUserName());
                    startActivity(intent);
                    MagPvpRanking.this.finish();
