...
public class MagSzkielet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AtakPotwora.AtakPotworaPotkiTest(hpPotion,manaPotion,imageB,imageBatakuj,imageP,mag,szkielet,szkielethp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill);
        ...
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walczzPotworemTest(imageBcrit,anim,imageBatakuj,imageB,imageP,mag,maghp,szkielet,szkielethp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskillaTest(imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,mag,maghp,szkielet,szkielethp,textHpB,textHpP,v,buttonSkill);
