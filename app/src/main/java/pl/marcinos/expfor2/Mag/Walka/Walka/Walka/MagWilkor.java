...
public class MagWilkor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mag_wilkor);
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MagWilkor.this,MagMenuActivity.class);
                startActivity(intent);
                MagWilkor.this.finish();
            }
        });
        ...
        progresHpP.setMax(wilkorhp.hp);
        progresHpB.setProgress(mag.hpbohater);
        progresHpP.setProgress(wilkor.hp);
        ...
        AtakPotwora.AtakPotworaPotkiTest(hpPotion,manaPotion,imageB,imageBatakuj,imageP,mag,wilkor,wilkorhp,textHpB,textHpP,progresHpB,progresHpP,buttonWalcz,buttonSkill);



        textHpB.setText("Hp bohatera: "+mag.hpbohater);
        textHpP.setText("Hp Potwora: "+wilkor.hp);
        ...
        buttonWalcz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walczzPotworemTest(imageBcrit,anim,imageBatakuj,imageB,imageP,mag,maghp,wilkor,wilkorhp,textHpB,textHpP,v,buttonWalcz);
        ...
        buttonSkill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Walka.walnijzeskillaTest(imageBcrit,imageSkillIkon,imageBskill,imageB,imageP,mag,maghp,wilkor,wilkorhp,textHpB,textHpP,v,buttonSkill);
    ...
    public void nextFight(View v) {
        ...
        alertDialogBuilder.setPositiveButton(("Walcze dalej!"), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MagWilkor.this,MagSzkielet.class);
                startActivity(intent);
                MagWilkor.this.finish();
                RegeneracjaPotworow.Regenereuj(guard,guardhp,hellgate,hellgatehp,wilkor,wilkorhp,mnich,mnichhp,moskit,moskithp,orc,orchp,rycerz,rycerzhp,stroz,strozhp,szkielet,szkielethp,wilkor,wilkorhp,zombie,zombiehp);
